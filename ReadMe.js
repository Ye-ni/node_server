...
//3. 파워쉘에서 nodemon을 이용하여 서버를 실행
// Set-ExecutionPolicy RemoteSigned -Scope CurrentUser

// 4. 메인 폴더에 public 폴더 생성
// public폴더에는 html, css, js, image 등의 정적파일(정적 자원)을 저장하는 공간이다.
// 웹브라우저에서 접근 가능한 파일들을 저장하는 폴더이다.
// public 폴덩에는 index.html 파일을 생성한다.
...
//  1) 웹브라우저의 주소창에 http://www.naver.com:8080/을 입력하면 웹브라우저는 www.naver.com 서버에 요청을 보낸다.
...
//  3) DNS 서버는 www.google.com을 IP 주소로 변환한 후 웹 브라우저에 전송한다.
//  4) 웹브라우저는 IP 주소를 받아서 해당 서버에 요청을 보낸다.
//  5) 웹브라우저는 웹서버가 보내온 페이지를 화면에 렌더링한다.

// 11. HTTP 요청 메소드
//  1) GET : 데이터를 요청할 때 웹브라우저의 주소창에 URL에 데이터를 붙여서 전송한다ㅏ.
...
//  4) 요청바디에는 요청에 대한 데이터가 포함되어 있다. 예를 들면 form + post 방식으로
